...
- [RFC-006: redaction](./RFC-006-redaction.md), in 2.4.0. Its section 6 records three deviations, one of which is that section 3.5 recommended letting a raw value cross a queue and the RFC's own section 1 is the argument against it.
